...
public interface MeshPartBuilder {
	...
	public static class VertexInfo implements Poolable {
		...
		public final Vector3 tangent = new Vector3(0, 0, 1);
		...
		public VertexInfo set (Vector3 pos, Vector3 nor, Color col, Vector2 uv) {
			return set(pos, nor, new Vector3(0, 0, 1), col, uv);
		}

		public VertexInfo set (Vector3 pos, Vector3 nor, Vector3 tan, Color col, Vector2 uv) {
			reset();
		...
		public VertexInfo setTan (Vector3 tan) {
			if ((hasNormal = tan != null) == true) tangent.set(tan);
			return this;
		}
		...
		public VertexInfo lerp (final VertexInfo target, float alpha) {
			...
			if (hasTangent && target.hasTangent) tangent.lerp(target.tangent, alpha);
